...
if (empty($_POST["name"])) {
    die('<script type="text/javascript">alert("Enter Your Name");location.replace("signup.html")</script>');
}
...
if ($_POST["password"] !== $_POST["password_confirmation"]) {
    die('<script type="text/javascript">alert("Passwords Not Matched.");location.replace("signup.html")</script>');
