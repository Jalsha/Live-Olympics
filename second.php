...
<head>
    ...
    <title> Brazil Wins Olympic Gold</title>
...
<body>
  ...
  <header class="continer-fluid ">
     ...
     <div class="page-nav no-margin row">
            <div class="container">
                <div class="row">
                    <h2>Brazil Wins Olympic Gold</h2>
                    <ul>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row no-margin video-cover">
                            <iframe width="1280" height="720" src="https://www.youtube.com/embed/gIWky-QlSvA" title="Brazil vs Germany 1-1 (Pens 5:4) Highlights & Goals - Olympics Rio Final 2016" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> </p>
