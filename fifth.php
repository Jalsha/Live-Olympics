...
<head>
    ...
    <title>Ana Vazquez (Archer) | Lifestyle</title>
...
<body>
  ...
  <header class="continer-fluid ">
     ...
     <div class="page-nav no-margin row">
            <div class="container">
                <div class="row">
                    <h2>Ana Vazquez (Archer) | Lifestyle</h2>
                    <ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <iframe width="1225" height="689" src="https://www.youtube.com/embed/DokFw54jagI" title="Ana Vazquez (Archer) Lifestyle, Networth, Age, Boyfriend, Income, Facts, Hobbies, Family, & More" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
