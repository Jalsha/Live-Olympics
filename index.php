...
<html lang="en">
    ...
    <head>
        ...
        <title>
            Live Olympic Games Streaming</title>
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a href="tenth.php">
                                        <img src="assets/images/video/banner_3.jpeg" class="d-block w-100" alt="...">
                                        <div class="detail-card">
                                            <p>History of Swimming || Elaine Gail Morao
                                            </p>
                                        </div>
                                    </a>
                                </div>
                                <div class="carousel-item">
                                    <a href="eleventh.php">
                                        <img src="assets/images/video/banner_6.webp" class="d-block w-100" alt="...">
                                        <div class="detail-card">
                                            <p>Olympic Dreams | Meeting Mary Kom
                                            </p>
                                        </div>
                                    </a>
                                </div>
                                <div class="carousel-item">
                                    <a href="ninth.php">
                                        <img src="assets/images/video/banner_4.webp" class="d-block w-100" alt="...">
                                        <div class="detail-card">
                                            <p>INDIVIDUAL SPORTS (Track & Field Events or Athletics)
                                            </p>
                                        </div>
                                    </a>
                                </div>
                ...
                <div class="video-row row">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="video-card">
                                <a href="third.php">
                            <img src="assets/images/blog/trending_1.webp">
        ...
        <section class="sesion-type">
            <div class="container">
                <div class="inner-title row">
                    <h2>Videos</h2>
                    <p>Watch Different Categories of Videos</p>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="single-sess">
                            <img src="assets/images/blog/tennis.jpeg" alt="">
                            <p>Live Sports</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="single-sess">
                            <img src="assets/images/blog/og-1.jpeg" alt="">
                            <p>Olympic Parade</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="single-sess">
                            <img src="assets/images/blog/og-2.jpeg" alt="">
                            <p>Olympic Medal Winners</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="single-sess">
                            <img src="assets/images/blog/og-3.webp" alt="">
                            <p>Olympic Venues</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="single-sess">
                            <img src="assets/images/blog/og-4.jpeg" alt="">
                            <p>Track & Field</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                ...
                <div class="container">
                    <div class="row col-det">
                        <div class="col-lg-6 d-none d-lg-block">
                            <ul class="ulleft">
                                <li>
                                    <a href="mailto:liveolympicgames@olympics.com" class="header-link"></a>
                                    <i class="far fa-envelope"></i>
                                    liveolympicgames@olympics.com
                                    <span>|</span></li>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <ul class="ulright">
                                <li>
                                    <a href="signup.html"  class="header-link">     <i class="fas fa-user-plus">
                                        Register</i></a>
                               
                                    <span>|</span></li>
                                <li>
                                    <a href="login.php"  class="header-link"><i class="fas fa-user"> Login</i></a>
                                   </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="single-sess sess-ok">
                            ...
                            <form action="login.php"> <button class="btn btn-primary">View Videos</button></form>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <form action="signup.html">
                        <button class="btn btn-default">Register For Free</button>
                    </form>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <ul class="list-unstyled link-list">
                            <li>
                                <a ui-sref="about" href="login.php">Home</a>
                                
                            </li>
                            <li>
                                <a ui-sref="portfolio" href="login.php">About Us</a>
                                
                            </li>
                            <li>
                                <a ui-sref="products" href="login.php">Schedule</a>
                                
                            </li>
                            <li>
                                <a ui-sref="gallery" href="login.php">Video Gallery</a>
                                
                            </li>
                            <li>
                                <a ui-sref="contact" href="login.php">Contact</a>
                    ...
                    <div class="col-md-4 col-sm-12 map-img">
                        ...
                        <address class="md-margin-bottom-40">
                            ...
                            Kathmandu, Nepal
                            <br>
                            <a href="login.php">Send Email</a><br>
                        </address>
